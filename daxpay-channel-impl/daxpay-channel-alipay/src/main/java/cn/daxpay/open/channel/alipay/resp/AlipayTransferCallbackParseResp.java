...
/// # 支付宝转账回调验签解析响应(与主应用镜像)
///
/// 仅承载转账回调([cn.daxpay.open.channel.alipay.service.callback.AlipayCallbackParseService#parseTransfer])的结构化业务数据,
/// 与支付/退款回调响应 [AlipayCallbackParseResp] 解耦。
@Data
